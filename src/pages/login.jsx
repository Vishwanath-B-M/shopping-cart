...
export default function Login(){
    ...
    <div className=" bg-white-700">
        ...
        <div>{login?<div className="flex flex-col items-center p-2 object-cover">
                <input type="text" value={username} onChange={e=>setusername(e.target.value)} placeholder="username" className="w-64 h-8 lg:w-96 lg:h-16  border-2 lg:gap-2 p-2 lg:text-3xl border-1 gap-2  textxl rounded-2xl"/>
                <input type="text" value={password} onChange={e=>setpassword(e.target.value)} placeholder="password"className="w-64 h-8 mt-2 lg:w-96 lg:h-16 border-2 lg:gap-4 p-2 lg:mt-4 lg:text-3xl border rounded-2xl gap-2 textxl"/>
                ...
                <button type="submit" className="w-32 lg:w-64 h-16
           ...
           {!login? <div className="flex flex-col items-center p-4">
                <input type="email" placeholder="email"className="w-62 h-8 lg:w-96 lg:h-16 border-2 gap-2 p-2 lg:text-3xl text-xl rounded-2xl"/>
                <input type="text" placeholder="password"className="w-62 h-8 lg:w-96 lg:h-16 border-2 gap-2 p-2 mt-2 lg:text-3xl text-xl rounded-2xl"/>
                <input type="text" placeholder="confirm password"className="w-62 h-8 lg:w-96 lg:h-16 border-2 lg:gap-4 p-2 mt-2 lg:text-3xl  gap-2 text-xl rounded-2xl"/>
                <button type="submit" className="w-32  lg:w-64 h-16 lg:gap-4 text-black lg:text-4xl bg-white/40  lg:border-4 border-white/40 lg:rounded-3xl shadow-lg lg:hover:text-5xl lg:m-4 

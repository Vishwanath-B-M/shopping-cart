    ...
    <div className=" bg-white-700">
        ...
        <div>{login?<div className="flex flex-col items-center p-4 object-cover">
           ...
           {!login? <div className="flex flex-col items-center p-4">
                <input type="email" placeholder="email"className="w-48 h-8 lg:w-96 lg:h-16 border-2 gap-2 p-2 lg:text-3xl text-2xl rounded-2xl"/>
                <input type="text" placeholder="password"className="w-48 h-8 lg:w-96 lg:h-16 border-2 gap-2 p-2 mt-2 lg:text-3xl text-2xl rounded-2xl"/>
                <input type="text" placeholder="confirm password"className="w-48 h-8 lg:w-96 lg:h-16 border-2 lg:gap-4 lg:p-4 lg:mt-4 lg:text-3xl  gap-2 text-2xl rounded-2xl"/>

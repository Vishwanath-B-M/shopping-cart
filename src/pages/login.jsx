...
export default function Login(){
    ...
    <div className=" bg-white-700">
        ...
        <div>{login?<div className="flex flex-col items-center p-2 object-cover">
                <input type="text" value={username} onChange={(e)=>setusername(e.target.value)} placeholder="username" className="w-64 h-8 lg:w-96 lg:h-16  border-2 lg:gap-2 p-2 lg:text-3xl border-2 gap-2  text-xl rounded-2xl"/>
                ...
                <p>{message}</p>
                <p className="textxl lg:text-3xl mt-4">not a member ? <a onClick={()=>{setlogin(false)}} className="bg-white/40 border-2 p-2 gap-2 text-2xl hover:backdrop-blur hover:text-4xl rounded-xl">signup now </a></p>
            </div>:""}
           {!login? <div className="flex flex-col items-center p-4">
                <input type="email" placeholder="email"className="w-64 h-8 lg:w-96 lg:h-16 border-2 gap-2 p-2 lg:text-3xl text-xl rounded-2xl"/>
                <input type="password" placeholder="password"className="w-62 h-8 lg:w-96 lg:h-16 border-2 gap-2 p-2 mt-2 lg:text-3xl text-xl rounded-2xl"/>
                <input type="password" placeholder="confirm password"className="w-62 h-8 lg:w-96 lg:h-16 border-2 lg:gap-4 p-2 mt-2 lg:text-3xl  gap-2 text-xl rounded-2xl"/>

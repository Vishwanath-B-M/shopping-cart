...
export default function Login(){
    ...
    <div className=" bg-white-700">
        ...
        <div>{login?<div className="flex flex-col items-center p-4 object-cover">
                <input type="text" value={username} onChange={e=>setusername(e.target.value)&&setusername("")} placeholder="username" className="lg:w-120 h-15 border-2 gap-4 p-4 text-3xl sm:w-60 h-5 border-1 gap-2 p-1 text-2xl"/>
                <input type="text" value={password} onChange={e=>setpassword(e.target.value)} placeholder="password"className="lg:w-120 h-15 border-2 gap-4 p-4 mt-4 text-3xl sm:w-60 h-5 border-1 gap-2 p-1 text-2xl"/>
